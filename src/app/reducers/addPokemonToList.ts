...
export const addPokemonToList = createAsyncThunk("pokemon/addPokemon",async (pokemon :{id:number, name: string, types:pokemonTypeInterface[] | string[],stats?:pokemonStatsType[]},{getState, dispatch}) => {
    try {
